          ...
          sliver: SliverGrid(
            ...
            delegate: SliverChildListDelegate([
              _QuickActionCard(
                ...
                onTap: () => handleSupervisorNavigation(context, 1, 0),
              ),
              _QuickActionCard(
                icon: Icons.people_alt_rounded,
                label: l10n.driversAndSupervisors,
                color: const Color(0xFF7C3AED),
                onTap: () => handleSupervisorNavigation(context, 2, 0),
              ),
              _QuickActionCard(
                icon: Icons.sos_rounded,
                label: l10n.incidentsAndEmergencies,
                color: AppColors.error,
                onTap: () => handleSupervisorNavigation(context, 4, 0),
              ),
              _QuickActionCard(
                icon: Icons.fact_check_rounded,
                label: l10n.fieldInspection,
                color: const Color(0xFFF59E0B),
                onTap: () => handleSupervisorNavigation(context, 5, 0),
              ),
              _QuickActionCard(
                icon: Icons.timer_off_rounded,
                label: l10n.registerDelays,
                color: const Color(0xFFF59E0B),
                onTap: () => handleSupervisorNavigation(context, 6, 0),
              ),
              _QuickActionCard(
                icon: Icons.explore_rounded,
                label: l10n.fieldTrips,
                color: const Color(0xFF10B981),
                onTap: () => handleSupervisorNavigation(context, 7, 0),
              ),
              _QuickActionCard(
                icon: Icons.bar_chart_rounded,
                label: l10n.reports,
                color: const Color(0xFF8B5CF6),
                onTap: () => handleSupervisorNavigation(context, 8, 0),
              ),
            ]),
          ),
        ),
